...
Apply an agent by using {{site.data.keyword.bpshort}}. For more information, see [{{site.data.keyword.bpshort}} Agents](/docs/schematics?topic=schematics-agents-intro).

Syntax

```sh
ibmcloud schematics agent apply --id AGENT_ID [--force-redploy] [--output OUTPUT] [--no-prompt]
```
{: pre}
...
| `--force-redeploy` or `-f` | Optional | Force redeploy the Agent. |
...
Create an agent by using {{site.data.keyword.bpshort}}. Agents help you to run your workspace jobs on your infrastructure. For more information, see [{{site.data.keyword.bpshort}} Agents](/docs/schematics?topic=schematics-agents-intro).
...
| `--clusterid` or `-k` | Required | The ID of the Kubernetes cluster for deploying the Agent.|
...
Retrieve an agent by using {{site.data.keyword.bpshort}}. Agents help you to fetch your workspace jobs on your infrastructure. For more information, see [{{site.data.keyword.bpshort}} Agents](/docs/schematics?topic=schematics-agents-intro).

Syntax

```sh
ibmcloud schematics agent get --id AGENT_ID [--profile PROFILE] [--output OUTPUT] [--no-prompt]
```
{: pre}
...
Lists the agents by using {{site.data.keyword.bpshort}}. Agents shows all the registered agents on your infrastructure. For more information, see [{{site.data.keyword.bpshort}} Agents](/docs/schematics?topic=schematics-agents-intro).

Syntax

```sh
 ibmcloud schematics agent list [--region REGION] [--filter NEW] [--limit LIMIT] [--offset OFFSET] [--output OUTPUT_FORMAT]
```
{: pre}
...
| Flag | Required / Optional |Description |
| ----- | -------- | ------ |
| `--region` or `-r` | Optional |  Specify the region. such as `eu`, `us`, `eu-gb`, `eu-de`, `us-south`, `us-east`. |
| `--filter` | Optional | Set this flag to filter agents. Valid values are `all`, `saved`, or `new`. If unset defaults to `saved`. |
| `--limit` or `-l` | Optional | Maximum number of Agents to list. Ignored if a negative number is set. Maximum: 200. (default: -1) |
...
Generates an agent plan by using {{site.data.keyword.bpshort}}. For more information, see [{{site.data.keyword.bpshort}} Agents](/docs/schematics?topic=schematics-agents-intro).

Syntax

```sh
ibmcloud schematics agent plan --id AGENT_ID [--output OUTPUT] [--no-prompt]
```
{: pre}
...
{{site.data.keyword.bpshort}} Agent beta-1 release supports backward compatibility of {{site.data.keyword.bpshort}} Agents beta features for your usage till future notice. To view the agent beta documentation, see [{{site.data.keyword.bpshort}} Agents beta release in production](/docs/schematics?topic=schematics-schematics-relnotes&interface=ui#schematics-july1122).
{: preview}
...
Create a policy using {{site.data.keyword.bpshort}} to select one or more {{site.data.keyword.bpshort}} objects (such as, Workspaces, Action, Blueprint) to deliver targeted {{site.data.keyword.bpshort}} feature. For example, use policy to select Workspaces that can be assigned to an agent. 
{: shortdesc}
